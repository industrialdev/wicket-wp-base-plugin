 ...
 * 2025-02-27 - Esteban
 *
 * Introduces the use of wicket_get_resource_type_name_by_slug(). See base plugin helpers.
 *
            ...
            if(connection.org_parent_name) {
              if(connection.org_parent_name !== null) {
                ...
                orgParentName = connection.org_parent_name;
						...
						<div
							class="<?php echo defined('WICKET_WP_THEME_V2') ? 'component-org-search-select__card-top-header' : 'flex mb-2 items-center' ?>">
					...
					<div
						class="current-org-listing-right <?php echo defined('WICKET_WP_THEME_V2') ? '' : 'flex items-center gap-1' ?>">
						<?php get_component('button', [
      'variant'  => 'secondary',
      'reversed' => false,
