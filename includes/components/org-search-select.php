...
?>
	...
	<div
      ...
      if (empty($title)) : ?>
			...
			<template x-for="(connection, index) in currentConnections" :key="connection.connection_id" x-transition>
                ...
                && connection.active_connection"
					class="component-org-search-select__card <?php if (!defined('WICKET_WP_THEME_V2')) : ?>rounded-100 flex flex-col md:flex-row md:justify-between bg-white p-4 mb-3<?php endif; ?>"
      ...
      'atts'     => [ 'x-on:click.prevent="terminateRelationship($data.connection.connection_id)"',
		...
		<div class="component-org-search-select__search-controls">
...
'atts'  => [ 'x-on:click.prevent="handleSearch()"' ],
	...
	<div x-show="firstSearchSubmitted && !disableCreateOrgUi" x-cloak
		...
		<div
			class="component-org-search-select__cant-find-org-title <?php echo defined('WICKET_WP_THEME_V2') ? '' : 'font-bold text-body-md mb-2' ?>">
