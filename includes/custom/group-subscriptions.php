 ...
 */
add_filter('woocommerce_product_data_tabs', 'wicket_product_data_tabs');

function wicket_product_data_tabs($tabs) {
  global $post;
 ...
 */
add_action('woocommerce_product_data_panels', 'wicket_product_tab_content');

function wicket_product_tab_content() {
  global $post;
  ...
  if ( has_term( $group_product_category, 'product_cat', $post->ID ) ) { ?>
    <style>.custom-wicket-tab { display: none; }</style>
 ...
 */ 
add_action('woocommerce_process_product_meta', 'wicket_woocommerce_process_product_meta');

function wicket_woocommerce_process_product_meta($post_id) {
 ...
 */
add_action('wcs_subscription_renewal_payment_complete', 'group_membership_subscription_renewal_completed', 10, 1);

function group_membership_subscription_renewal_completed( $sub ) {
  $group_memberships = [];
