...
function wicket_enqueue_wc_org_scripts()
{
    ...
    wp_enqueue_script('custom-wc-org', plugins_url('../../assets/js/wicket_wc_org.js', __FILE__), ['jquery'], null, true);
    wp_localize_script('custom-wc-org', 'ajax_object', ['ajax_url' => admin_url('admin-ajax.php')]);
}
