...
/*
 * Wicket WooCommerce Checkout Addresses
 * Description: Provides the ability for users to prepopulate addresses from their person record for the checkout billing and shipping fields. It also allows for saving addresses to the person record on checkout completion based on the info in either the shipping or billing fields
 *
 */
...
function add_checkout_fields($fields)
{
    ...
    $address_types = array_filter($resource_types['data'], function ($val) {
        return ($val['attributes']['available_for_entity'] == 'all_entities' || $val['attributes']['available_for_entity'] == 'person')
