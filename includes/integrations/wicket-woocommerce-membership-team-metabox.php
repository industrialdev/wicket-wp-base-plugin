...
if ( ! class_exists( 'Wicket_Woo_Team_Metabox' ) ) {
    ...
    class Wicket_Woo_Team_Metabox {
        ...
        public function __construct() {
            ...
            add_filter( 'wc_memberships_for_teams_allowed_meta_box_ids', array( $this, 'allow_custom_wicket_field_metaboxes' ) );

            // create meta box
            add_action( 'add_meta_boxes', array( $this, 'wicket_team_meta_box' ) );
            // Save MetaBox Values
            add_action( 'save_post_wc_memberships_team', array( $this, 'wicket_team_save_metabox_values' ) );
        ...
        */
        ...
        public function wicket_team_meta_box() {
           add_meta_box(
               ...
               array( $this, 'wicket_team_metabox_cb' ), // callback function name.
