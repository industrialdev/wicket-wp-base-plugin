 ...
 * Description: Providies a widget with a form to update a persons wicket password
 *
 */

// The widget class
// http://www.wpexplorer.com/create-widget-plugin-wordpress
class UpdatePassword extends \WP_Widget
{
    public $errors;
    ...
    public static function init()
    {
        add_action('init', function () {
            if (isset($_POST['wicket_update_password'])) {
                ...
                if (isset($wp_widget_factory->widgets['wicket_update_password'])) {
                    $widget = $wp_widget_factory->widgets['wicket_update_password'];
                    $widget->process_form();
                } else {
    ...
    private function process_form()
    {
        ...
        if (isset($_POST['wicket_update_password'])) {
            ...
            * Update Password
            ...
            if (isset($_SESSION['wicket_password_form_errors'])) {
                unset($_SESSION['wicket_password_form_errors']);
            }
        }
    }
