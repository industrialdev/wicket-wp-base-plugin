...
/**
 * Deprecated HyperPress procedural aliases (hm_*, hxwp_*).
 *
 * Kept in the global namespace for the same reason helpers.php is: legacy
 * themes call hm_get_endpoint_url() / hxwp_send_header_response()
 * unqualified from global scope. Loaded by HyperPress\Bootstrap::init()
 * alongside helpers.php.
 */
